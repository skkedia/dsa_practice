...
public class BalancedBinaryTree {
    ...
    private void dfs(int curr, int ancestor, boolean[] visited, List<List<Integer>> graph,
    ...
    private String findDup(Node root, List<Node> ans) {
        ...
        sb.append(root.data).append(",").append(findDup(root.left, ans)).append(",")
                .append(findDup(root.right, ans));
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        new BalancedBinaryTree()
                .minDifference(new int[] {1, 5, 0, 10, 14, -1, -8, 50, 100, 45, 78});
